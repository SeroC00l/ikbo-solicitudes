...
var middlewareSecret = "b5f41a81-7f72-4678-b275-f0d5ca4d6b1f";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "b5f41a81-7f72-4678-b275-f0d5ca4d6b1f") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
